            ...
            <div>
              ...
              <div className="flex space-x-3 mb-4">
                {[
                  {
                    icon: Facebook,
                    href: "https://www.facebook.com/profile.php?id=61578874657907",
                  },
                  {
                    icon: Instagram,
                    href: "https://www.instagram.com/revanimoveis?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
                  },
                  {
                    icon: Linkedin,
                    href: "https://www.linkedin.com/company/revanimoveis/",
                  },
                  {
                    icon: Youtube,
                    href: "https://www.youtube.com/@revanimoveis",
                  },
                  {
                    icon: () => (
                      <svg
                    ...
                    href: "https://www.tiktok.com/@revanimoveis",
                  },
                ].map((social, index) => {
